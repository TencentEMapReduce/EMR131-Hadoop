  ...
  protected void renderData(Block html) {
    ...
    for (ApplicationReport appReport : appReports) {
      ...
      appsTableData
        ...
        .append("\",\"")
        .append(app.getReservedCpuVcores() == -1 ? UNAVAILABLE : app.getReservedCpuVcores())
        .append("\",\"")
        .append(app.getReservedMemoryMB() == -1 ? UNAVAILABLE : app.getReservedMemoryMB())
        .append("\",\"")
        .append(app.getAllocatedCpuVcores() == -1 ? UNAVAILABLE : app.getAllocatedCpuVcores())
        .append("\",\"")
        .append(app.getAllocatedMemoryMB() == -1 ? UNAVAILABLE : app.getAllocatedMemoryMB())
        .append("\",\"")
        .append(app.getRunningContainers() == -1 ? UNAVAILABLE : app.getRunningContainers())
        .append("\",\"")
        .append(UNAVAILABLE)
        .append("\",\"")
        .append(UNAVAILABLE)
