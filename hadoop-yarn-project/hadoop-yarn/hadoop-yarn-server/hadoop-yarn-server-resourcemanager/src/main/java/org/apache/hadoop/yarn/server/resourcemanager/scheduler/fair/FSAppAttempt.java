...
public class FSAppAttempt extends SchedulerApplicationAttempt
  ...
  synchronized public void containerCompleted(RMContainer rmContainer,
    ...
    attemptResourceUsage.decUsed(containerResource);
  ...
  private synchronized void unreserveInternal(
    ...
    attemptResourceUsage.decReserved(resource);

    LOG.info("Application " + getApplicationId() + " unreserved " + " on node "
        + node + ", currently has " + reservedContainers.size() + " at priority "
        + priority + "; currentReservation " + attemptResourceUsage.getReserved());
  }
  ...
  synchronized public RMContainer allocate(NodeType type, FSSchedulerNode node,
    ...
    attemptResourceUsage.incUsed(container.getResource());
