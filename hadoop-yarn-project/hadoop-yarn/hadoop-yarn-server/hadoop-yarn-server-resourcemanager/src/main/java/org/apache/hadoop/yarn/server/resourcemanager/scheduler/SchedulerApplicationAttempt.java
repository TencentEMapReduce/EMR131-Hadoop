...
public class SchedulerApplicationAttempt {
  ...
  public synchronized RMContainer reserve(SchedulerNode node, Priority priority,
    ...
    if (rmContainer == null) {
      ...
      attemptResourceUsage.incReserved(container.getResource());
    ...
    if (LOG.isDebugEnabled()) {
      LOG.debug("Application attempt " + getApplicationAttemptId()
          ...
          + "; currentReservation " + attemptResourceUsage.getReserved());
    }
      ...
      for (Priority priority : getPriorities()) {
        ...
        if (requests != null) {
          LOG.debug("showRequests:" + " application=" + getApplicationId() + 
              ...
              " currentConsumption=" + attemptResourceUsage.getUsed().getMemory());
  ...
  public synchronized ApplicationResourceUsageReport getResourceUsageReport() {
    ...
    return ApplicationResourceUsageReport.newInstance(liveContainers.size(),
               ...
               resUsage.getMemorySeconds(), resUsage.getVcoreSeconds(), queueUsagePerc, clusterUsagePerc);
  }
  ...
  public synchronized void recoverContainer(RMContainer rmContainer) {
    ...
    attemptResourceUsage.incUsed(rmContainer.getContainer().getResource());
